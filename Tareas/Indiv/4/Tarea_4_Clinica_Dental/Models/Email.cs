    ...
    public class Email
    {
        ...
        public void Enviar(Paciente paciente)
        {
            try
            {
                ...
                email.Subject = "Cita en la Clinica Dental San Basilio";
                ...
                string html = "Bienvenidos a la Clinica Dental San Basilio";
                ...
                html += "<br>";
                html += "<br>No responda a este cooreo porque fue creado de manera automatica</b>";
...
}//Fin namespace Tarea_3_Clinica_Dental.Models
