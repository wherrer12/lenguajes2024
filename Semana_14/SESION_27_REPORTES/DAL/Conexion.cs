    ...
    {   //Variable Conexion
        ...
        public void GuardarUsuario(Usuario usuario)
        {
            try
            {
                ...
                _command.Connection = _connection; //Se asigna la conexion al procedimiento almacenado
                _command.CommandType = CommandType.StoredProcedure; //Se indica el tipo de comando
                _command.CommandText = "[Sp_Ins_Usuarios]"; //Se indica el nombre del procedimiento almacenado a ejecutar
                _command.Parameters.AddWithValue("@Email", usuario.Email); //Muy importante darle el valor al parametro
                _command.Parameters.AddWithValue("@NombreComp", usuario.NombreCompleto); //Muy importante darle el valor al parametro
                _command.Parameters.AddWithValue("@Passwd", usuario.Password); //Muy importante darle el valor al parametro
        ...
        public void ModificarUsuario(Usuario usuario)
        {
            try
            {
                ...
                _command.Parameters.AddWithValue("@Email", usuario.Email); //Se asigna el valor al email
